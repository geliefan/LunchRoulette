...
class TestWeatherService:
    ...
    def test_get_weather_summary(self, weather_service, mock_cache_service):
        ...
        assert result == "晴れ 25.0°C UV指数5.0"
